## Fig5restricted.R  PY and deaths only up to end of 2019 to make sure excess OC are not from COVID
...
ggsave(file=paste0("outs/Fig5restricted.png"),height=3,width=4) 
