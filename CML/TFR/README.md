...
Three preliminary steps are needed before running the 2D spline scripts Fig5A_2Dto22.R and Fig5A_2Dto19.R. They are: 1) Fig5_1mkAges.R, which estimates 
...
To see how much OC excess mortality in this plot is due to COVID, Fig5_2Dto19A.R restricts survival times 
...
bigger than E, so this approximation is valid.  Generated by Fig5A.R, the new Figure 5A is then
![](pngs/Fig5A.png)
