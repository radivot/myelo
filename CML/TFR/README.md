...
Finally, 3 preliminary steps are needed before running scripts that create variants of Figure 5A. They are: 1) Fig5_1mkAges.R, which estimates 
...
fitting; and 3) Fig5_3mkSplineXX.R files that perform surface spline fitting to create single-year resolution mortality matrices.  
...
bigger than E, so this approximation is valid.  Generated by fig5OCequalsAC.R, the new Fig. 5 is then
![](pngs/Fig5OCequalsAC.png)
Advantages of this approach include using SEER data from 2020, 2021, and 2022 and avoiding surface-spline fits.  


Finally, implementing the method described in Appendix B, B_setpointWatershed.R maps 
setpoints and watersheds to Hahnel model parameters $K_z$ and $p_z$. 
