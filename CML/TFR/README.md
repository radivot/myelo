...
To see how much OC excess mortality in this plot is due to COVID, Fig5_2Dto19.R restricts survival times 
...
bigger than E, so this approximation is valid.  Generated by Fig5_OCequalsAC.R, the new Figure 5A is then
![](pngs/Fig5_OCequalsAC.png)
Advantages of this approach include using 2020-2022 SEER data and avoiding surface-spline fits. This version is in the paper. 
