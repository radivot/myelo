#'Periodic CML model of Colijn and Mackey (JTB 2005)
#'
...
colijn05a<-function(Time, State, Pars) {
	with(as.list(c(State, Pars)), {
          ...
          dQ=-(beta+kN+kP+kR)*Q + Aq*betat*Qt
				  ...
				  dR=-gamR*R + Ar*(exp(-gamR*tauRet)*kRtsum1*Qrtsum1-exp(-gamR*tauSum)*kRtsum2*Qrtsum2) 
