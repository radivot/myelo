# TR's 5/27/13 derivative of myeloC.R, which came after N4.R 
# Model of Myeloid Cell Maturation and trafficking
#
library(deSolve)
...
#imab = imatinib, here functionaly equivalent to anti-TNF monoclonal antibody (7)
#ifna = interferon alpha (8)
#antiox = ascorbic acid, antoxidant (9)


fcopd <- function(Time, State, Pars) {
  with(as.list(c(State, Pars)), {
    ...
    return(list(c(dP,dQ,dN,dTN,dAN,dGM,dNAP2,dRAC2,dMCL1,dROS,dBACT,dABL,dGSH,dGSSG),
                c(g=g,il3=il3,
                  ...
                  vX.MCL1=vX.MCL1,vMCL1.X=vMCL1.X,tvN.M=vN.M,vBACT.X=vBACT.X,v14=vRAC2.X,v18=vX.ROS,
...
#      GM=3.97,NAP2=.01004, RAC2=26.59, MCL1=2.021, ROS=1.967, 
#      BACT=1e6, ABL=0, GSH=1e6, GSSG=0)                                                                       
# 
X0copd=structure(c(1525964.98747372, 38267.7398498231, 2310608.31203527, 
            255575.821189267, 1638.67822476995, 7.14080290521397, 0.136436781609195, 
            260.801733715492, 27.2873563218391, 473.322146122923, 9.18348145019615e-41, 
            12.6436781609195, 724750.048613635, 275249.951386366), 
          .Names = c("P", 
                     "Q", "N", "TN", "AN", "GM", "NAP2", "RAC2", "MCL1", "ROS", "BACT", 
                     "ABL", "GSH", "GSSG"))
...
pars=c(Vx.p=1.7e4, Kil3=1, Vp.p=.0203, Kgm=2, Kcn=100, Vp.n=.026, Kg=1, Kmo=1,
       ...
       Vgsh.gssg=382.8, Vgssg.gsh=155.8,Kgssg=30,Kros=30, Kgsh=9.5e5, 
       Vn.m=1.309e-3,Kros2=.104,
       Kseli=.3, Kifna=1, Vbact.x=5.756e-2, nHr=2.5,kkmax=320,
       Vx.abl=.22,Ktnfa=1,Kimab=1, Vabl.x=.0145, Ka2=.5, Km0=.1,                                 
       il8=4, tnfa=5,Qf=.0373, volP=2900, volM=1400, volT=65700,
       # these are drug concentration boundary conditions 
