library(deSolve) 
?events  # below is from this help page. (?roots gives same page)
# Note:  event times must also be part of the integration output times
...
derivs <- function(t, var, parms)   list(c(0, -0.5 * var[2]))  
