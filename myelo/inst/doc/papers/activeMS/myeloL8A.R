 # myeloL8A.R  PD Model of CML 1 March 2014
 # This version models constant drug concentrations.
 #
 library(deSolve)
 ...
 return(list(c(dP,dQ,dN,dTN,dAN,dGM,dstat5,dstat3,dMcl1,dROS,dabl,dg,dil3,dMYC,dgsh,dGSSG),
 ...
 pars=c(Ka2=.5, Kabl=1, Kabl2=1, Kabl3=1, Kan=100, Kastat5=.1, Kdas=85, Kg=1, Kgm=2, Kgsh=30, Kgsh.x=5.0, Kgssg=30, Kil3=100, Kil8=396,  
      ...
      MYC=9.01, PClimit=6e6, Vg=.045,                                                            # these are boundary  conditions
...
#     ke=.161, ka=.98, Fpc=80, Vd=2.9, MW=354,                                                   # PK/PD parameters for seliciclib
      ...
      BcrAbl=13, gb=51.2, il3=36, MYC=10.2, gsh=7e5, GSSG=1.5e5)				 # Starting values for variables                 						 # Enter dose of drug being modelled in mg/m^2
 ...
 main = "myeloL8A.R: Uninhibited control", log="y", lwd = 2)
